...
export default function MetricsBar({ metrics }: MetricsBarProps) {
  ...
  return (
    <div className="flex-shrink-0 flex items-center h-10 px-2" style={{ background: 'var(--bg-primary)', borderTop: '1px solid var(--border-secondary)', boxShadow: '0 -1px 3px rgba(31,35,40,0.03)' }}>
      {/* Adaptability */}
